\chapter[Minimal Dark Matter Freeze-in with Low Reheating Temperatures]{Minimal Dark Matter Freeze-in with Low Reheating Temperatures and Implications for Direct Detection}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=.7\linewidth]{figures/ch08/Yield_vs_x_v1_mDM_30MeV.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=.7\linewidth]{figures/ch08/sigmaDDes_limit_plot_vG.png}
    \caption[Freeze-in cross sections for DM-electron scattering]{The updated range of direct detection cross sections allowed by the freeze-in scenario (labeled ``Freeze-in Region''), when accounting for all possible reheating temperatures above the BBN bound. Only for $T_{\rm{rh}}\gg m_\chi$ do we recover the previously understood freeze-in benchmark, which corresponds to the bottom solid green line. Shaded in gray are the current experimental constraints from DAMIC-M~\cite{DAMIC-M:2023gxo,DAMIC-M:2023hgj}, DarkSide~\cite{DarkSide:2022knj}, PandaX~\cite{PandaX:2022xqx}, SENSEI~\cite{SENSEI:2020dpa} and XENON1T~\cite{XENON:2018voc,Hambye:2018dpi}. }
    \label{fig:ch8-1}
\end{figure}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=.7\linewidth]{figures/ch08/kappa_limit_plot.png}
    \caption[Portal coupling constraints from nuclear recoils]{Updated range of portal couplings $\kappa$ allowed by the freeze-in scenario (labeled ``Freeze-in Region") when accounting for reheating temperatures $T_{\rm{rh}}\lesssim m_\chi$. The previously understood freeze-in benchmark with $T_{\rm{rh}}\gg m_\chi$ corresponds to the bottom solid green line. Shaded in gray are the current experimental constraints from PandaX~\cite{PandaX-II:2017hlx} and XENON1T~\cite{XENON:2018voc,Hambye:2018dpi}. }
    \label{fig:ch8-2}
\end{figure}
