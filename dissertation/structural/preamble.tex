...
% ── Overrides of utformat defaults ──────────────────────────────────
\makeatletter
% Left-align chapter headings (utformat centres them)
\def\@makechapterhead#1{{\parindent 0pt \raggedright
    \ifnum \c@secnumdepth >\m@ne \Large\bf \@chapapp{} \thechapter:~\fi
    \Large \bf #1\par \nobreak \vskip 35pt}}
...
% Per-chapter bibliography as \section* (not \chapter*) for chapterbib
